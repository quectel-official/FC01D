...
#ifndef __QL_HTTPS_H__
#define __QL_HTTPS_H__


#include <stddef.h>
#include "ql_https.h"
#define WEBCLIENT_USING_MBED_TLS 1
#define RT_FALSE 0
#define RT_TRUE 1
#define RT_EOK 0
#define ql_http_log bk_printf
...
typedef void (*http_call_back)(char *data,size_t len);
...
int webclient_request(const char *URI, const char *header, const void *post_data, size_t data_len, void **response, size_t *resp_len, http_call_back fn);
