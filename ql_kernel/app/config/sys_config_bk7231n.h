...
#define CFG_SUPPORT_SPI_FLASH_TEST                  1
...
#define CFG_SUPPORT_MONGOOSE                       1

#define TCP_CLIENT_DEMO                            1


#define CFG_MAGIC_SYSREQ                           0

#define CFG_MBEDTLS   1

#define CFG_USE_4M_FLASH                           1

#define CFG_QUEC_FTP                               1
#define CFG_TLSF_SUPPORT                           0
#if (CFG_TLSF_SUPPORT)
#define HEAP_MEM_DEBUG                             1
#define MM_HEAD_BOUNDARY                           1
#endif
