...
ble_err_t app_ble_create_advertising(uint8_t actv_idx, uint8_t chnl_map, uint32_t intv_min, uint32_t intv_max, uint8_t filter);
...
void app_ble_list_set_ral_cmd(void);
void app_ble_list_clear_ral_cmd(void);
void app_ble_list_set_wl_cmd(void);
void app_ble_list_clear_wl_cmd(void);
void app_ble_remove_device_from_white_list(struct white_list * addr_info);
void app_ble_set_address_resolution_enable(bool enable);
uint8_t app_ble_get_bonded_white_list_size(void);
ble_err_t app_ble_get_bonded_white_list(uint8_t wl_idx, struct white_list *p_wl);
