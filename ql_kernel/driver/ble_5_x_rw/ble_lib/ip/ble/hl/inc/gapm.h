...
void gapm_le_set_address_resolution_enable(bool enable);
void gapm_list_send_hci_le_rmv_dev_from_wlst_cmd(struct gap_bdaddr const *p_addr);
...
/**
 ****************************************************************************************
 * @brief Set pref MTU value
 *
 * @param[in] pref MTU size
 ****************************************************************************************
 */
 void gapm_set_pref_mtu(uint16_t mtu_size);
